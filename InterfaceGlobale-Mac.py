...
def ChapChoix():
    ...
    titre = Label(fenetre, text= "Entiers signés", font=("Courier", 40, "italic"), fg='blue4', bg='snow')
    ...
    def Exercice1(f, select):
        ...
        def alea(man,ko):
            ...
            if man ==1:
                ...
                A1=Radiobutton(fen,text="Décimal",selectcolor=dicoNb[basedep][4],state=dicoNb[basedep][0], fg='blue4', bg='Gainsboro',indicatoron=0,width=26, height=2, cursor='hand2')
                A2=Radiobutton(fen,text="Binaire",selectcolor=dicoNb[basedep][5],state=dicoNb[basedep][1], fg='blue4', bg='Gainsboro',indicatoron=0,width=26, height=2, cursor='hand2')
                A3=Radiobutton(fen,text="Hexadécimal",selectcolor=dicoNb[basedep][6],state=dicoNb[basedep][2], fg='blue4', bg='Gainsboro',indicatoron=0,width=26, height=2, cursor='hand2')
                A4=Radiobutton(fen,text="Octal",selectcolor=dicoNb[basedep][7],state=dicoNb[basedep][3], fg='blue4', bg='Gainsboro',indicatoron=0,width=26, height=2, cursor='hand2')
                
                A5=Radiobutton(fen,text="Décimal",selectcolor=dicoNb[basearr][4],state=dicoNb[basearr][0], fg='blue4', bg='Gainsboro',indicatoron=0,width=26, height=2, cursor='hand2')
                A6=Radiobutton(fen,text="Binaire",selectcolor=dicoNb[basearr][5],state=dicoNb[basearr][1], fg='blue4', bg='Gainsboro',indicatoron=0,width=26, height=2, cursor='hand2')
                A7=Radiobutton(fen,text="Hexadécimal",selectcolor=dicoNb[basearr][6],state=dicoNb[basearr][2], fg='blue4', bg='Gainsboro',indicatoron=0,width=26, height=2, cursor='hand2')
                A8=Radiobutton(fen,text="Octal",selectcolor=dicoNb[basearr][7],state=dicoNb[basearr][3], fg='blue4', bg='Gainsboro',indicatoron=0,width=26, height=2, cursor='hand2')
        ...
        if man==2:
            ...
            A1=Radiobutton(fen,text="Décimal", fg='blue4', bg='Gainsboro',variable=basedepart,value=10,indicatoron=0,width=26, height=2, cursor='hand2')
            A2=Radiobutton(fen,text="Binaire", fg='blue4', bg='Gainsboro',variable=basedepart,value=2,indicatoron=0,width=26, height=2, cursor='hand2')
            A3=Radiobutton(fen,text="Hexadécimal", fg='blue4', bg='Gainsboro',variable=basedepart,value=16,indicatoron=0,width=26, height=2, cursor='hand2')
            A4=Radiobutton(fen,text="Octal", fg='blue4', bg='Gainsboro',variable=basedepart,value=8,indicatoron=0,width=26, height=2, cursor='hand2')

            A5=Radiobutton(fen,text="Décimal", fg='blue4', bg='Gainsboro',variable=basearrivee,value=10,indicatoron=0,width=26, height=2, cursor='hand2')
            A6=Radiobutton(fen,text="Binaire", fg='blue4', bg='Gainsboro',variable=basearrivee,value=2,indicatoron=0,width=26, height=2, cursor='hand2')
            A7=Radiobutton(fen,text="Hexadécimal", fg='blue4', bg='Gainsboro',variable=basearrivee,value=16,indicatoron=0,width=26, height=2, cursor='hand2')
            A8=Radiobutton(fen,text="Octal", fg='blue4', bg='Gainsboro',variable=basearrivee,value=8,indicatoron=0,width=26, height=2, cursor='hand2')
...
#===================== Chapitre 1 - Exercice 7 ===========================================
    def Exercice7(f, select):
        ...
        def create():
            ...
            btn = Button(rappel,text='Quitter',command=exit_btn,font=("calibri", 18, "bold"), fg='black', bg='grey', width=15, height=2)
            btn.grid(row=6, column=2,columnspan=3,sticky='n')
...
#===================== Chapitre 1 - Exercice 8 ============================================
    def Exercice8(f,select):
        ...
        txtQ2=Label(fenetre, text="  Mots contenus dans la case", font=("courier", 20), fg='black', bg='lightskyblue1')
        ...
        txtQ11.grid(row=10, column=2,columnspan=3,sticky='w')
        NumPTab.grid(row=10, column=4,columnspan=5,ipadx=100,ipady=10,sticky='w')

        txtQ12.grid(row=11, column=2,columnspan=3,sticky='w')
        NumDTab.grid(row=11, column=4,columnspan=5,ipadx=100,ipady=10,sticky='w')


        txtQ2.grid(row=13, column=2,columnspan=3,sticky='w')
        MotCase.grid(row=13,column=4,columnspan=5,ipadx=100,ipady=10,sticky='w')

        txtQu2.grid(row=13, column=1,sticky='w')
        ...
        #========================================================================================       
            ...
            def CreaCase():
                ...
                if ok!=1:
                    ...
                    frame_main.grid(column=7,row=6,columnspan=11,sticky='w')
                    ...
                    for i in range(Duree):
                        ...
                        Temps=Label(frame_buttons, text=ValTemps ,font=("courier", 11), fg='black', bg='lightskyblue1')
            ...
            tmr=Button(fenetre, text="Valider\n saisie ", state='disabled',font=("calibri", 15,"bold",), fg='black', bg='steelblue', width=13, height=0,command=lambda:validerSaisie(Duree))
            ...
            OK=Button(fenetre, text="Débloquer données", font=("calibri", 15, "bold",), fg='black', bg='steelblue', width=17, height=0,command=lambda:debloq())
            ...
            GO=Button(fenetre, text="GO", font=("calibri", 18, "bold", 'underline'), fg='black', bg='steelblue',state='disabled', width=5, height=0,command=lambda:buttonGo(Type))
            GO.grid(row=4, column=10,columnspan=12)
         


            affcase=Button(fenetre, text="Afficher les cases",state='disabled', font=("calibri", 15, "bold"), fg='black', bg='steelblue', width=17, height=0,command=lambda:CreaCase())
