...
def PageChoix(NomExercice): #======== Fenêtre de demande aléatoire ou manuel ===========
    ...
    bManuelle=Button(cadre3, text="Manuel", font=("courier", 18, "italic"), fg='white', bg='#103985', command=CommandExo('Manuel'))
    bManuelle.pack(fill=X, padx=10, ipadx= 25, ipady= 25, side='left')

    bAléa=Button(cadre3, text="Aléatoire", font=("courier", 18, "italic"), fg='white', bg='#103985',command=CommandExo('Aléa'))
    bAléa.pack(fill=X, padx=16, ipadx= 25, ipady= 25, side='right')

    bRetour=Button(cadre4, text="Retour", font=("courier", 18, "italic"), fg='white', bg='#103985', command=back)
    bRetour.pack(pady=10, fill=X)

    return(TypeSaisie)#====== en cours
...
def Menu():
    ...
    def Chap1(): #=====Chap1 est la 2eme fenetre contenant les 8 exercices
        ...
        Bexo2=Button(cadre2, text="Opérations en binaire", font=("courier", 18, "italic"), fg='white', bg='#103985', width=largeur, height=hauteur ,command= partial(PageChoix,"Opérations en binaire"))
