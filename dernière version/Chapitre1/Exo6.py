...
##                    print(cpt_nb)
            ...
            ch = '.'.join(liste)
            return(ch)
##            return(ch, cpt_nb) #ajoute une virgule
        elif base == 10:
...
##        global apresvirgule
        ...
        if apresvirgule > '5' :
            messagebox.showerror("showerror", "Mauvaise saisie, Il ne faut pas excéder 5 nombres après la virgule")
            return(1)
        ...
        if ordre == "2":
            ...
            if ok==False: 
                messagebox.showerror("showerror", "Erreur de saisie du nombre décimal")
                return(1)
            elif ok2==False:
    ...
    def create():
        ...
        txt1=Label(rappel, text="Pour obtenir la partie décimale : \n on utilise la méthode de la multiplication", font=("courier", 20, "italic"), fg='black', bg='lightskyblue1',width=60, height=2)
        txt1.grid(row=2, column=2, columnspan= 5)
        ...
        btn.grid(row=4, column=2,columnspan=3,sticky='n')
