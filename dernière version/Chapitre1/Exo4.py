...
def Exo4(f, select):
    ...
    if man==2:
        ...
        def control2(ch):
            if not CtrlSyntaxe(ch,2,1,35):
                ok=False
                messagebox.showerror("ATTENTION !", "Mauvaise saisie de votre résultat.")
    ...
    B2=Button(fenetre, text="Nouveau", font=("courier", 18, "bold"), fg='white', bg='#103985', width=15, height=2,command=lambda:Nouveau())
    B3=Button(fenetre, text="Valider", font=("courier", 18, "bold"), fg='white', bg='#103985', width=15, height=2,command=lambda:Exercice4())
    B4=Button(fenetre, text="Score", font=("courier", 18, "bold"), fg='white', bg='#103985', width=15, height=2)
